class Persona {
    ...
    static contadorOpersona = 0; 
    constructor(nombre,apellido,edad){

        this._idPersona = ++Persona.contadorOpersona;
        this._nombre = nombre;
...
let empleado1 = new Empleado('Camila' , ' Lopez', 25, 5000 );
...
let cliente2 = new Cliente('sofia', 'Castro', 23, new Date());
